...
run-ml-bootstrap-hub:
	...
	./node_modules/.bin/ml-bootstrap hub -c ./config/ml-bootstrap.json5

run-ml-bootstrap-participants:
	ELB_URL=${BASE_URL}/api/admin
	FSPIOP_URL=${BASE_URL}/api/fspiop  
	./node_modules/.bin/ml-bootstrap partcipants -c ./config/ml-bootstrap.json5

run-ml-bootstrap-parties:
	ELB_URL=${BASE_URL}/api/admin
	FSPIOP_URL=${BASE_URL}/api/fspiop  
	./node_modules/.bin/ml-bootstrap parties -c ./config/ml-bootstrap.json5
